 ...
 *
 * Icons (all 7 entry types covered):
...
public class SidebarIcon implements Icon {
    ...
    // ===== ICON TYPE =====
    public enum Type { ACCOUNT, NOTE, ADDRESS, CARD, PASSKEY, SSH, VPN, BINARY, DOCUMENTS }
     ...
     * All 7 types have custom icons - never returns null.
     *
     * @param typeKey  entry type key - "account","note","address",
     *                 "card","passkey","ssh","vpn"
